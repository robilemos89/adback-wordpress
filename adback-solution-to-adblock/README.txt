...
= 3.2.3 =
* Fix code issue with old versions of PHP

= 3.2.2 =
* Fix page parameters check

= 3.2.1 =
* Typo

= 3.2.0 =
* Update robots.txt with endpoints to prevent false indexation

= 3.1.2 =
* See your login information in parameter page
...
= 3.0.3 =
* Choose your email on activation
...
= 3.0.0 =
* Add support for a light version of the plugin to display a simple message to quickly monetize your audience

= 2.11.0 =
* RGPD compliant

= 2.10.2 =
* Display all information on diagnostic screenshot

= 2.10.1 =
* Allow to refresh scripts

= 2.10.0 =
* Add button to download diagnostic status

= 2.9.15 =
* Do not force proxy usage
...
= 2.9.9 =
* Use wordpress language to manage registration

= 2.9.8 =
* Update proxy

= 2.9.7 =
* Remove use of __DIR__ constant
