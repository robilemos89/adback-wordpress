...
<div id="ab-login">
	<div class="ab-col-md-6">
			<div class="ab-login-box">
				<h2><?php esc_html_e('Register with AdBack', 'ad-back'); ?></h2>
				...
				<center>
					<button class="button button-primary" id="ab-login-adback" style="width:100%;margin-top: 30px;"><?php esc_html_e('Activate my AdBack', 'ad-back'); ?></button>
				</center>
				<center>
					<button
